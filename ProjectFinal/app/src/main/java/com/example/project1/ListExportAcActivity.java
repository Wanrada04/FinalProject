...
public class ListExportAcActivity extends AppCompatActivity {
    private String TAG = ListExportAcActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_list_export_ac);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        contactList = new ArrayList<>();
        listView = (ListView) findViewById(R.id.list_export_ac);
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()) {
            case R.id.history:
                Intent intent = new Intent(ListExportAcActivity.this, ListExportHisActivity.class);
    ...
    private class GetPlaces extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            Toast.makeText(ListExportAcActivity.this, "รายการกิจกรรม", Toast.LENGTH_LONG).show();
...
//
        ...
        protected void onPostExecute(Void result) {
            ...
            ListAdapter adapter = new SimpleAdapter(ListExportAcActivity.this, contactList,
                    R.layout.list_st_activity, new String[]{"ActivityTitle", "CreateDate", "DateFrom", "DateTo", "InstructorName"},
                    new int[]{R.id.textTitle1, R.id.textCreate, R.id.day1, R.id.day3, R.id.tInName});
            ...
            listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(final AdapterView<?> adapter, final View v, final int position, long arg) {
                    ...
                    Intent intent = new Intent(ListExportAcActivity.this, ResultExportAcActivity.class);
