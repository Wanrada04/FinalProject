...
public class ResultAcActivity extends AppCompatActivity {
    private String TAG = ResultAcActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_result_ac);
        contactList = new ArrayList<>();
        listView = (ListView) findViewById(R.id.list_result_ac);
...
//    }
    ...
    class retrievedata extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... arg0) {
            ...
            String url1 = "http://" + IPConnect.IP_CONNECT + "/android/count_resultac.php";
            session = new SessionManager(getApplicationContext());
            HashMap<String, String> user = session.getUserDetails();
            ID = user.get(SessionManager.KEY_ID);

            String TempHolderID = getIntent().getStringExtra("ActivityID");



            url1 += "?InstructorID=" + ID + "&ActivityID= " + TempHolderID ;
    ...
    private class GetPlaces extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            Toast.makeText(ResultAcActivity.this, "ผลการเข้าร่วมกิจกรรม", Toast.LENGTH_LONG).show();
        ...
        protected void onPostExecute(Void result) {
            ...
            ListAdapter adapter = new SimpleAdapter(ResultAcActivity.this, contactList,
                    R.layout.list_result_ac, new String[]{"StudentID","StudentName","CreateDate"}, new int[]{
                            R.id.textStID, R.id.textSTName,R.id.textCreate});
