...
public class ListExportHisActivity extends AppCompatActivity {
    private String TAG = ListExportHisActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_list_export_his);
    ...
    private class GetPlaces extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            Toast.makeText(ListExportHisActivity.this, "ประวัติการเข้ากิจกรรม", Toast.LENGTH_LONG).show();
...
//        }
        ...
        protected void onPostExecute(Void result) {
            ...
            ListAdapter adapter = new SimpleAdapter(ListExportHisActivity.this, contactList,
            ...
            listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(final AdapterView<?> adapter, final View v, final int position, long arg) {
                    ...
                    Intent intent = new Intent(ListExportHisActivity.this, ListExportResultHisActivity.class);
