...
public class ResultExportAcActivity extends AppCompatActivity {
    private String TAG = ResultExportAcActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_result_export_ac);
...
//        url += "?InstructorID=" + ID + "&ActivityID= " + TempHolder ;
    ...
    private class GetPlaces extends AsyncTask<Void, Void, Void> implements View.OnClickListener {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            Toast.makeText(ResultExportAcActivity.this, "สรุปผลการเข้ากิจกรรม", Toast.LENGTH_LONG).show();
