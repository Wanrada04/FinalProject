...
public class SubStActivity extends AppCompatActivity {

    private String TAG = SubStActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sub_st);
    ...
    private class GetPlaces extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            Toast.makeText(SubStActivity.this, "ข้อมูลรายวิชา", Toast.LENGTH_LONG).show();
        ...
        protected void onPostExecute(Void result) {
            ...
            ListAdapter adapter = new SimpleAdapter(SubStActivity.this, contactList,
