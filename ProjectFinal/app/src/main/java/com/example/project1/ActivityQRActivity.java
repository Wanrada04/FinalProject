...
public class ActivityQRActivity extends AppCompatActivity {
    ImageView imageView;
    Button button;
    TextView TextQR;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String ShowTxt= getIntent().getStringExtra("ActivityID")+"-"+getIntent().getStringExtra("ActivityTitle");
                String TempHolder = getIntent().getStringExtra("ActivityID")+"-"+getIntent().getStringExtra("ActivityTitle")+"-"+currentDate+"-"+"02";
