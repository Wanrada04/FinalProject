...
public class ListExportSubActivity extends AppCompatActivity {
    private String TAG = ListExportSubActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_list_export_sub);
        contactList = new ArrayList<>();
        listView = (ListView) findViewById(R.id.list_exsub);
        ...
        private class GetPlaces extends AsyncTask<Void, Void, Void> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                Toast.makeText(ListExportSubActivity.this, "ข้อมูลรายวิชา", Toast.LENGTH_LONG).show();
...
//            startActivity(intent);
            ...
            protected void onPostExecute(Void result) {
                ...
                ListAdapter adapter = new SimpleAdapter(ListExportSubActivity.this, contactList,
...
//                    final int i = listView.getPositionForView((View) v.getParent());
                        ...
                        Intent intent = new Intent(ListExportSubActivity.this, ResultExportSubActivity.class);
